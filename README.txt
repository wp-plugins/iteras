...
This plugin allows you to quickly set up a paywall in WordPress, integrating with your ITERAS subscriber base. All you have to do is set up a landing page for visitors who are not logged in.

The plugin uses the ITERAS Javascript API that also allows further customizations if you need it.
...
3. Go to the plugin settings (either from the dashboard or from Settings->ITERAS) and fill in the requested details. You'll need to setup a landing page for the paywall.
